...
const Banner = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center  ">
      ...
      {/* Text Section */}
      <div className="max-w-[1099px]  md:w-[50%] bg-[#B6E82A] h-auto md:h-[366px] flex flex-col justify-center items-center relative">
        ...
        <div className="absolute bottom-0 -left-8 w-full lg:block hidden">
